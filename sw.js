const CACHE_NAME='restaurant-os-v2-shell-v7';
const SHELL=['./','./index.html','./config.js','./app.js?v=9','./cart-bridge.js?v=2','./delivery-gps-clean-v2.js?v=2','./delivery-admin-enhancements.js?v=1','./pwa-install.js?v=9','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
