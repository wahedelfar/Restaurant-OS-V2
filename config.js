  ...
  demoProducts: [
    {
      id: 'p1',
      category_id: 'cat1',
      name: 'كومبو بيتزا وبرجر',
      description: 'بيتزا + برجر + بطاطس',
      price: 280,
    ...
    },
    {
      ...
      category_id: 'cat2',
      name: 'بيتزا بيبروني',
      description: 'جبنة موزاريلا وبيبروني',
      price: 180,
    ...
    },
    {
      ...
      category_id: 'cat2',
      name: 'بيتزا تشيكن',
      description: 'دجاج، مشروم، موزاريلا',
      price: 170,
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  s.onload = function () {
    ...
    f.onload = function () {
      try {
        window.renderRouter && window.renderRouter();
      } catch (e) {
        console.error(e);
      }
    };
