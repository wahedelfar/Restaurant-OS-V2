window.APP_CONFIG = {
  ...
  demoProducts: [
    {
      id: 'p1', category_id: 'cat1', name: 'كومبو بيتزا وبرجر',
      description: 'بيتزا + برجر + بطاطس', price: 280,
      image: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800',
      available: true, sort_order: 1
    },
    {
      id: 'p2', category_id: 'cat2', name: 'بيتزا بيبروني',
      description: 'جبنة موزاريلا وبيبروني', price: 180,
      image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=800',
      available: true, sort_order: 2
    },
    {
      id: 'p3', category_id: 'cat2', name: 'بيتزا تشيكن',
      description: 'دجاج، مشروم، موزاريلا', price: 170,
      image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=800',
      available: true, sort_order: 3
    },
    {
      id: 'p4', category_id: 'cat3', name: 'تشيز برجر',
      description: 'لحم، جبنة، صوص خاص', price: 150,
      image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800',
      available: true, sort_order: 4
    },
    {
      id: 'p5', category_id: 'cat4', name: 'بطاطس',
      description: 'بطاطس مقرمشة', price: 60,
