(function(){
  ...
  function adminCard(offer){
    ...
    const status=host.querySelector('#ros-daily-offer-status');status.textContent=offer?.active?'العرض ظاهر للعملاء':'العرض مخفي';host.querySelector('#ros-daily-offer-close').addEventListener('click',()=>host.remove());
