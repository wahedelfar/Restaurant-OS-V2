const CACHE_NAME='restaurant-os-v2-shell-v48';
const SHELL=['./','./index.html','./manifest.json','./icon-180.png?v=3','./icon-192.png?v=3','./icon-512.png?v=3','./icon.svg?v=26','./config.js?v=4','./app.js?v=15','./pwa-bootstrap-v1.js?v=28','./pwa-install.js?v=15','./daily-offer-v1.js?v=1','./ui-cleanups-v1.js?v=1','./ros-realtime-notifications-v1.js?v=1'];
